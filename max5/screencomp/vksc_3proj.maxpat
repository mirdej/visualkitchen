{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 644.0, 596.0, 640.0, 506.0 ],
		"bglocked" : 0,
		"defrect" : [ 644.0, 596.0, 640.0, 506.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "preferences_dir VisualKitchen",
					"fontsize" : 12.0,
					"numinlets" : 0,
					"patching_rect" : [ 30.0, 82.0, 170.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-6",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 0,
					"patching_rect" : [ 59.0, 198.0, 87.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-1",
					"fontname" : "Arial"
				}
...
, 											{
												"box" : 												{
													...
													"fontsize" : 12.0,
													"numinlets" : 2,
													"patching_rect" : [ 72.0, 217.0, 32.5, 20.0 ],
													"numoutlets" : 1,
													"id" : "obj-11",
													"fontname" : "Arial",
													"outlettype" : [ "int" ]
