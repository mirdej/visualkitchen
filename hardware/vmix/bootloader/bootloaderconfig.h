 ...
 */
#define SIGNATURE_BYTES             0x1e, 0x94, 0x03, 0     /* ATMega16 */
...
#define LED_BIT  	5   /* jumper is connected to this bit in port D, active low */
...
static inline void  bootLoaderInit(void)
{
	...
	DDRD = (1 << LED_BIT);				// set led pin to output
    PORTD = (1 << LED_BIT);                 // turn yellow led off
