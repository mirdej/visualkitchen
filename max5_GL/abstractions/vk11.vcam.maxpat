{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 72.0, 72.0, 557.0, 549.0 ],
		"bglocked" : 0,
		"defrect" : [ 72.0, 72.0, 557.0, 549.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "r vcam_slab",
					"outlettype" : [ "" ],
					"patching_rect" : [ 328.0, 415.0, 75.0, 20.0 ],
					"id" : "obj-1",
					"fontname" : "Arial",
					"numinlets" : 0,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 29.0, 69.0, 997.0, 785.0 ],
						"bglocked" : 0,
						"defrect" : [ 29.0, 69.0, 997.0, 785.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "p offset",
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.0, 234.0, 50.0, 20.0 ],
					"id" : "obj-81",
					"fontname" : "Arial",
					"numinlets" : 0,
					"fontsize" : 12.0,
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"text" : "pak offset 0. 0.",
									"outlettype" : [ "" ],
									"patching_rect" : [ 144.0, 325.0, 89.0, 20.0 ],
									"id" : "obj-1",
									"fontname" : "Arial",
									"numinlets" : 3,
									"fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"text" : "r all_dims",
									"outlettype" : [ "" ],
									"patching_rect" : [ 200.0, 61.0, 62.0, 20.0 ],
									"id" : "obj-58",
									"fontname" : "Arial",
									"numinlets" : 0,
									"fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 251.0, 123.0, 20.0 ],
									"id" : "obj-53",
									"fontname" : "Arial",
									"numinlets" : 6,
									"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "p rotation",
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.0, 234.0, 61.0, 20.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"numinlets" : 0,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 44.0, 465.0, 176.0, 20.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 214.5, 438.0, 53.5, 438.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 337.5, 449.5, 53.5, 449.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 195.5, 265.0, 214.5, 265.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 257.5, 265.0, 214.5, 265.0 ]
				}
