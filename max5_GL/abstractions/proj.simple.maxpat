...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 339.0, 73.0, 125.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 111.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 82.0, 111.0, 150.0, 20.0 ],
					"text" : "Interpolation",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 89.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 82.0, 89.0, 150.0, 20.0 ],
					"text" : "Interpolation",
					"textcolor" : [ 0.917647, 0.917647, 0.917647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.0, 96.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 82.0, 67.0, 150.0, 20.0 ],
					"text" : "Interpolation",
					"textcolor" : [ 0.917647, 0.917647, 0.917647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 153.0, 113.0, 329.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 19.0, 329.0, 35.0 ],
					"text" : "Simple Projector",
...
,
					"patching_rect" : [ 99.0, 19.0, 36.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 54.0, 66.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 85.0, 57.0, 18.0 ],
					"text" : "interp $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 632.0, 175.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 54.0, 110.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 632.0, 199.0, 57.0, 18.0 ],
					"text" : "interp $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 343.0, 271.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 54.0, 88.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.0, 198.0, 51.0, 18.0 ],
					"text" : "interp 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.0, 299.0, 57.0, 18.0 ],
					"text" : "interp $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 132.0, 156.0, 408.0, 20.0 ],
					"text" : "jit.gl.render proj @shared_context comp @erase_color 0. 0. 0. 1. @ortho 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 443.0, 237.0, 223.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 397.5, 218.5, 452.5, 218.5 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 352.5, 321.5, 114.5, 321.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 641.5, 223.5, 452.5, 223.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 108.5, 55.0, 141.5, 55.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 165.5, 139.5, 452.5, 139.5 ],
					"source" : [ "obj-7", 1 ]
				}
