...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.slab proj @file cf.gaussian.2p.jxs",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 33.0, 702.0, 210.0, 20.0 ],
					"id" : "obj-37",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.imageunit proj @fx \"White Point Adjust\"",
					"numinlets" : 2,
					"fontsize" : 11.595187,
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 33.0, 450.333344, 237.0, 20.0 ],
					"id" : "obj-19",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.imageunit proj @fx Bloom",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 187.0, 522.0, 173.0, 20.0 ],
					"id" : "obj-52",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.slab proj @file vk11.sk.jxs",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 33.0, 551.0, 173.0, 20.0 ],
					"id" : "obj-41",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.imageunit proj @fx \"Color Controls\"",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 33.0, 247.0, 224.0, 20.0 ],
					"id" : "obj-25",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jit.gl.imageunit proj @fx \"Edge Work\"",
					"numinlets" : 2,
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 33.0, 336.0, 206.0, 20.0 ],
					"id" : "obj-8",
					"fontname" : "Arial"
				}
